...
exports.Axios = Axios;
},{"./lib/axios.js":"node_modules/axios/lib/axios.js"}],"scripts/test.js":[function(require,module,exports) {
"use strict";
  ...
  return __awaiter(this, void 0, void 0, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = 'http://localhost:3000/api/v1/recently_played';
          _context.next = 3;
          return axios_1.default.get(url).then(function (response) {
            var table = document.getElementById('recently-played-table');
